...
public class TelaCliente extends javax.swing.JFrame {
    ...
    TelaCliente(ClienteDaoImp clienteDB, PaisDaoImp paisDB) {
        this();
    ...
    private void paisComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paisComboBoxActionPerformed
        ...
        for (Pais paisSelecionado : paisDB.listPais()) {
            if (paisSelecionado.getNome().equalsIgnoreCase((String) paisComboBox.getSelectedItem())) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String excluido = (String) JOptionPane.showInputDialog(this, "Informe ID do cliente a ser excluído");
        int idExcluido = Integer.parseInt(excluido);
        clienteDAO.delete(cliente, idExcluido);
